...
theme_btn = tk.Menubutton(toolbar,image=color_icons['Light Theme'])
...
font_box = ttk.Combobox(toolbar,width=30,textvariable=font_selected,state='readonly',cursor='hand2')
...
##size box
size_var = tk.IntVar()
font_size = ttk.Combobox(toolbar, width=14,textvariable=size_var,state='readonly',cursor='hand2')
...
undo_btn = ttk.Label(toolbar,image=off_undo_icon,cursor='hand2')
undo_btn.grid(row=0,column=5,padx=1)
createToolTip(undo_btn,"Undo")
redo_btn = ttk.Label(toolbar,image=off_redo_icon,cursor='hand2')
redo_btn.grid(row=0,column=6,padx=1)
createToolTip(redo_btn,"Redo")

separator = ttk.Separator(toolbar, orient=tk.VERTICAL).grid(row=0,column=7,padx=6,sticky="sn")
...
text_size_up_btn = ttk.Label(toolbar,image=text_size_up_icon,cursor='hand2')
text_size_up_btn.grid(row=0,column=9,padx=2)
createToolTip(text_size_up_btn,"Bigger Text")
text_size_down_btn = ttk.Label(toolbar,image=text_size_down_icon,cursor='hand2')
...
font_color_btn = ttk.Label(toolbar,image=font_color_icon,cursor='hand2')
font_color_btn.grid(row=0,column=11,padx=2)
createToolTip(font_color_btn,"Color Palette")

separator = ttk.Separator(toolbar, orient=tk.VERTICAL).grid(row=0,column=12,padx=6,sticky="sn")

##bold button
off_bold_icon = tk.PhotoImage(file='icons/off_bold.png')
on_bold_icon = tk.PhotoImage(file='icons/on_bold.png')
bold_btn = ttk.Label(toolbar,image=off_bold_icon,cursor='hand2')
...
italic_btn = ttk.Label(toolbar,image=off_italic_icon,cursor='hand2')
...
underline_btn = ttk.Label(toolbar,image=off_underline_icon,cursor='hand2')
underline_btn.grid(row=0,column=15,padx=2)
createToolTip(underline_btn,"Underline")

separator = ttk.Separator(toolbar, orient=tk.VERTICAL).grid(row=0,column=16,padx=6,sticky="sn")

##align left
on_align_left_icon = tk.PhotoImage(file='icons/align-left-2x.png')
align_left_btn = ttk.Label(toolbar,image = on_align_left_icon,cursor='hand2')
...
align_center_btn = ttk.Label(toolbar,image=on_align_center_icon,cursor='hand2')
...
align_right_btn = ttk.Label(toolbar,image = on_align_right_icon,cursor='hand2')
align_right_btn.grid(row=0,column=19,padx=2)
createToolTip(align_right_btn,"Align Right")

separator = ttk.Separator(toolbar, orient=tk.VERTICAL).grid(row=0,column=20,padx=6,sticky="sn")

## text to speech
tts_btn = ttk.Label(toolbar,image=tts_on_icon,cursor='hand2')
...
spell_check_btn = ttk.Label(toolbar,image=spell_check_on_icon,cursor='hand2')
spell_check_btn.grid(row=0,column=22,padx=2)
createToolTip(spell_check_btn,"Spell checker")

separator = ttk.Separator(toolbar, orient=tk.VERTICAL).grid(row=0,column=23,padx=6,sticky="sn")

## find button
find_btn = ttk.Label(toolbar,image=find_icon,cursor='hand2')
...
find_state = 0
find_label = ttk.Label(toolbar,text='Find',font=('InkFree',9))
find_label.grid(row=0,column=25)
find_var = tk.StringVar()
find_entry = ttk.Entry(toolbar,textvariable=find_var,width=20)
find_entry.grid(row=0,column=26)

replace_label=ttk.Label(toolbar,text='Replace',font=('InkFree',9))
replace_label.grid(row=0,column=27)
replace_var = tk.StringVar()
replace_entry = ttk.Entry(toolbar,textvariable=replace_var,width=20)
replace_entry.grid(row=0,column=28)

submit_icon = tk.PhotoImage(file='icons/enter.png')
submit_btn = ttk.Label(toolbar,image = submit_icon)
...
toolbar_state = tk.BooleanVar()
toolbar_state.set(True)
...
def show_hide_toolbar():
    global toolbar_state,status_bar_state
    if toolbar_state:
        toolbar.pack_forget()
        toolbar_state=False
    else:
